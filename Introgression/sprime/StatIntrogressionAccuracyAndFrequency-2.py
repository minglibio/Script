...
def StatIntrogressionAccuracyAndFrequency(iterate,IntroLen,TrueIntrogressiveVar,FalseIntrogressiveVar):
    ...
    TrueIntroFile = open('{0}GoatSimulation.i{1}.R1e-08.intro'.format(args.intro,iterate))
    AlleleDict = LoadVCF('{0}GoatSimulation.i{1}.R1e-08.vcf.gz'.format(args.intro,iterate), ScoreDict)
