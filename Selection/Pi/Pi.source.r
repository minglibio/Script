...
#print("Manhattan ploting Chromosomewise")
  ...
  pdf(paste("Pi.", name.of.trait,".Chromosomewise.pdf" ,sep = ""), width = 10)
  ...
  for(i in 1:numCHR)
  {
    ...
    ylab = "Pi", main = paste("Chromosome",chm.to.analyze[i],sep=" "),cex.lab=1 , pch=20, xaxs="i", yaxs="i" )
...
y.lim <- ceiling(max(GI.MP[,3]))
#y.lim= 0.75
  pdf(paste("Pi.", name.of.trait,".Genomewise.pdf" ,sep = ""), width = 15, height=3.5)
...
plot(y~x,ylab="Pi",  ylim=c(0,y.lim), xaxs="i", yaxs="i" ,type = "p", lwd=1.50, pch=20, cex.axis=0.5, cex.lab=1.0 ,col=mycols[z], axes=FALSE,  lty=1, cex=0.35, cex.main=2.0, xlab="Chromosome")
