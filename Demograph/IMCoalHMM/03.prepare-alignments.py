...
def main(chr,sample,input,window,output,queue,corenum,memory):
    '''
    input file:
    1       275406953
    2       248966461
    ...
    for line in chr :
        ...
        for i in range(1,Num + 1):
            if int(line[1]) - End <= window * 0.5:
                ...
                Command = f'python ~/software/IMCoalHMM-master/scripts/prepare-alignments.py {input}/{Region}.fa fasta {output}/{Region} --names {Sample}'
