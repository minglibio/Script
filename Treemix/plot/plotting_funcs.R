...
plot_tree = function(stem, o = NA, cex = 0.5, disp = 0.003, plus = 0.01, flip = vector(), arrow = 0.05, scale = T, ybar = 0.1, mbar = T, plotmig = T, plotnames = T, xmin = 0, lwd = 1, font = 1){
...
plot_resid = function(stem, pop_order, min = -0.009, max = 0.009, cex = 0.5, usemax = T, wcols = "r"){
